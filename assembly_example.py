...
#patterns supplied to the optional argument 'file_filter', or to all of them if
...
#the previous tasks. It has an optional param ('stop_on_miss') to determine whether
